...
namespace ControlTemplate
{
    public class MainModule:Module
    {
        protected override void Load(ContainerBuilder builder)
        {
            ...
            builder.Register(c => new TestViewModel()).AsSelf().SingleInstance();
            builder.Register(c => new MainViewModel(c.Resolve<Lazy<IChildWindowAsyncSevice>>(),c.Resolve<Func<TestViewModel>>())).AsSelf().SingleInstance();
